...
import json
import pandas as pd
# Import pad_sequences and tokenizer loader with fallback
try:
...
class LSTMWithAttention(nn.Module):
    ...
    def forward(self, x, lengths):
        ...
        attn_scores = self.attn(output).squeeze(-1)  # [B, T]
...
text = st.text_area("Paste text to classify:")
